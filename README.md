...
### 🎬 动效系统
- **蛇身特效**（10种）：呼吸灯、脉冲波纹、色彩波浪、星光闪烁、彩虹流光、外发光、水波纹、闪电、霓虹、火焰
- **蛇身动画**（4种）：抖动、波浪、弹跳、缠绕
- **蛇头动画**（5种）：点头、浮动、摇摆、颤抖、弹跳
- **尾巴动画**（5种）：摆尾、卷尾、脉动尾、火焰尾、流动尾
- **蛇头形状**（8种基础 + 7种像素素材）：三角形、长方形、正方形、圆形、菱形、箭头、六边形、星形 + 像素风/可爱风/龙族风/机械风/幽灵风/骑士风/外星风
- **皮肤纹理**（6种基础 + 7种像素素材）：纯色、鳞片、条纹、圆点、描边、十字 + 像素风/鳞甲纹理/装甲纹理/发光体/水晶体/电路板/熔岩体
...
| **渲染方式** | `requestAnimationFrame` | 60fps 帧率，隐藏时自动停止渲染，零 IO 占用 |
